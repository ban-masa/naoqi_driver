...
#include "subscribers/set_life_status.hpp"
...
void Driver::registerDefaultSubscriber()
{
  ...
  registerSubscriber( boost::make_shared<naoqi::subscriber::LifeStatusSubscriber>("set_life_status", "/set_life_status", sessionPtr_) );
}
